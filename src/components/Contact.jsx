...
const socialLinks = [
  {
    href: "https://github.com/LasveRat",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/%CF%86%CE%B1%CE%BC%CF%80%CE%B9%CE%AC%CE%BD-%CE%B2%CE%AD%CE%BB%CE%BB%CE%B1-024020311/",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/lasve_rat/",
    icon: (
      <svg
        width="25"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon, alt }, key) => (
              <a
                ...
                href={href}
                target="_black"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-colors hover:bg-zinc-50 hover:text-zinc-950 duration-300 active:scale-90 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/brolvvpa"
          method="POST"
          ...
          <div className="mb-4">
            <div className="reveal-up">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="johnvella2001@gmail.com"
                className="text-field reveal-up"
              />
            </div>
          </div>
